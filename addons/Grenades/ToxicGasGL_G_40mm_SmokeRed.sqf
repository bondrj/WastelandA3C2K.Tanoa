...
_gasMask = ["H_CrewHelmetHeli_B", "H_CrewHelmetHeli_O", "H_CrewHelmetHeli_I", "H_HelmetSpecB_sand", "H_HelmetSpecB_snakeskin", "H_HelmetSpecB_paint2", "H_HelmetSpecB_paint1", "H_HelmetSpecB_blk", "H_HelmetSpecB"]; // define the gasmasks here
...
setNoGasStatusGL={
    ...
    "dynamicBlur" ppEffectCommit 35;                    // time it takes to go back to normal vision
...
While{true} do{
	...
	waituntil{
        _smokeShell = nearestObject [getPosATL player, "G_40mm_SmokeRed"];
